...
const docs = {
  privacy: {
    ...
    content: `
      <h2>1. Who We Are</h2>
      <p>Rang is an AI-powered personal styling application built and operated by Sachin Rathod, based in Gandhinagar, Gujarat, India.</p>
      ...
      <p>To exercise any right, email <strong>outercirclelabs@gmail.com</strong> — we respond within 30 days.</p>

      <h2>8. AI Training Opt-Out</h2>
      <p>Go to <strong>Settings → Privacy → "Contribute to AI improvement"</strong> and toggle it off. Or email outercirclelabs@gmail.com. Opting out has no effect on your recommendations or service access.</p>

      <h2>9. Contact</h2>
      <p>Privacy questions: <strong>outercirclelabs@gmail.com</strong><br />
      Grievance Officer (India): Sachin Rathod, outercirclelabs@gmail.com<br />
  ...
  terms: {
    ...
    content: `
      <h2>1. Agreement</h2>
      <p>By creating an account or using Rang, you agree to these Terms of Service. These Terms constitute a legally binding agreement between you and Sachin Rathod, operating Rang from Gandhinagar, Gujarat, India.</p>

      <h2>2. The Service</h2>
      <p>Rang is an AI-powered personal styling application. Recommendations are generated by AI and are provided for informational purposes only. We do not guarantee that any recommendation will be flattering, available to purchase, or appropriate for every occasion.</p>

      <h2>3. Accounts</h2>
      <p>You must be at least 13 years old to use Rang. You are responsible for keeping your password secure and all activity under your account. You may not create multiple accounts to circumvent free tier limits.</p>
      ...
      <p>Recommendations are generated by AI and are suggestions only. Rang is not a substitute for professional styling, dermatological, or medical advice. If you have skin conditions or allergies, consult a professional.</p>
      ...
      <p>The Rang name, software, and fashion rules database are our intellectual property. You retain ownership of content you provide and grant us a license to use it to provide the Service.</p>
      ...
      <h2>12. Contact</h2>
      <p><strong>outercirclelabs@gmail.com</strong> — Response within 5 business days.</p>
    `
  },
  'data-policy': {
...
<Footer>
  ...
  <FooterText>© 2026 Rang · Built by Sachin Rathod</FooterText>
</Footer>
